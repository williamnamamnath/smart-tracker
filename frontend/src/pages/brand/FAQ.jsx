const FAQ = () => {
    ...
    return (
        ...
        <div className="m-3 p-3">
            ...
            <div className="p-3">
            <p>Please read below as we may find the answer to some of your questions. Should you feel the need to reach out to use directly for more specific question, please visit the last question of this page.</p>
